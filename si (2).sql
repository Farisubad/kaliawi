...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Mar 2023 pada 13.26
...
(6, '1809010075315745', 'Negeri Sakti', '017/012', 'Negeri Sakti', 'Gedong Tataan', 'Pesawaran', 'Lampung');
...
(6, 5, '1809002406010004', 'Faris Ubad Alfharuq', '202cb962ac59075b964b07152d234b70', 'Bandar Lampung', '2001-06-21', 'Laki-Laki', 'Islam', 'Wiraswasta/Pegawai Swasta', 'Belum Menikah', 'Kepala Keluarga', 'masyarakat'),
...
(10, 3, '123', 'ubed', '202cb962ac59075b964b07152d234b70', 'Bandar Lampung', '2023-03-16', 'Laki-Laki', 'Islam', 'TNI/POLRI', 'Menikah', 'Kepala Keluarga', 'masyarakat');
...
(5, 2, 1, 6, '2023-03-13', 'Diproses', '', 'Bab-5_OK10.pdf', '');
...
--
ALTER TABLE `kartu_keluarga`
  MODIFY `id_kk` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `masyarakat`
--
ALTER TABLE `masyarakat`
  MODIFY `id_m` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT untuk tabel `pelayanan`
--
ALTER TABLE `pelayanan`
  MODIFY `id_pelayanan` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

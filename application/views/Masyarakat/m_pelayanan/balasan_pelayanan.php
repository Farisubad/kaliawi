		...
		<div class="col-lg-10">
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h6 class="m-0 font-weight-bold text-primary">Detail Penolakan Pelayanan</h6>
				</div>
                            ...
                            <div class="form-group">
                                <select name="nik_m" id="nik_m" class="form-control" readonly value="<?php echo $pj->m_id ?>" name="alamat" placeholder="">>
                                    ...
                                    <?php foreach ($nama as $nm) : ?>
                                        <option <?= $pj->m_id == $nm['id_m'] ? 'selected' : ''; ?> hidden<?= set_select('m_id', $nm['id_m']) ?> <?= $nm['id_m'] ?>><?= $nm['nik'] ?> </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <select name="jenis_id" id="jenis_id" class="form-control" readonly value="<?php echo $pj->jenis_id ?>" name="alamat" placeholder="">>>
									...
									<div class="form-group">
										...
										<textarea rows="5" cols="55" class="form-control" readonly ><?php echo $pj->balasan ?></textarea>
										<!-- <br>
										<div>
                                        <textarea rows="5" cols="55" class="form-control" readonly value="<?php echo $pj->balasan ?>" name="alamat" placeholder=""></textarea><br/>
										</div> -->
									</div>
